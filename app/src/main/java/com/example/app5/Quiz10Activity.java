...
public class Quiz10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(view -> {
            ...
            intent.putExtra("RESP6", getIntent().getBooleanExtra("RESP6", false));
            intent.putExtra("RESP7", getIntent().getBooleanExtra("RESP7", false));
            intent.putExtra("RESP8", getIntent().getBooleanExtra("RESP8", false));
            intent.putExtra("RESP9", getIntent().getBooleanExtra("RESP9", false));

            if (radioButton1.isChecked()) intent.putExtra("RESP10", true);
            else if (radioButton2.isChecked()) intent.putExtra("RESP10", false);
            else if (radioButton3.isChecked()) intent.putExtra("RESP10", false);
            else if (radioButton4.isChecked()) intent.putExtra("RESP10", false);
